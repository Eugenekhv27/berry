...
const routes: Routes = [{
  ...
  children: [
    ...
    { path: 'reports/bonusesyears', component: BonusTurnoverYearReportComponent, canActivate: [AuthGuard] },
    { path: 'reports/bonuses/:begindate/:enddate', component: BonusTurnoverReportComponent, canActivate: [AuthGuard] },
